...
public class HandgunReloading : MonoBehaviour {
	...
	/*when were reloading we don't want to be able to fire our gun. We need to disable every mechanism of our gun whilst reloading.
	  This includes the crosshair animation
	*/
	public GameObject CrossObject;

	//Variable which will enable us to turn off our mechanics.
